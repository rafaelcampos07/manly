...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    if (!email.trim() || !password.trim()) return Alert.alert('Erro', 'Preencha todos os campos')
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.logoContainer}>
            <LinearGradient colors={[COLORS.blue, COLORS.blueLight]} style={styles.logoCircle}>
              <Text style={styles.logoText}>M</Text>
            </LinearGradient>
            <Text style={styles.appName}>MANLY</Text>
            <Text style={styles.tagline}>Eleve Sua Vida</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.registerContainer}>
              ...
              <TouchableOpacity onPress={() => router.push('/register')}><Text style={styles.registerLink}>Cadastre-se</Text></TouchableOpacity>
            </View>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  keyboardView: { flex: 1 },
  scrollContent: { flexGrow: 1, paddingHorizontal: SPACING.lg, paddingTop: SPACING.xxl * 2, paddingBottom: SPACING.xl },
  logoContainer: { alignItems: 'center', marginBottom: SPACING.xl },
  logoCircle: { width: 72, height: 72, borderRadius: 36, alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.smd },
  logoText: { fontSize: 32, fontWeight: '700', color: COLORS.white },
  appName: { fontSize: 26, fontWeight: '800', color: COLORS.white, letterSpacing: 4, marginBottom: SPACING.xs },
  tagline: { fontSize: 13, color: COLORS.gray500 },
  ...
  form: { marginTop: SPACING.smd },
  title: { ...TYPOGRAPHY.h1, color: COLORS.white, marginBottom: SPACING.xs },
  subtitle: { ...TYPOGRAPHY.bodySmall, color: COLORS.gray500, marginBottom: SPACING.xl },
  ...
  forgotPasswordText: { color: COLORS.blue, fontSize: 13 },
  loginButton: { marginTop: SPACING.sm, marginBottom: SPACING.lg },
  ...
  registerContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
  registerText: { color: COLORS.gray500, fontSize: 14 },
  registerLink: { color: COLORS.blue, fontWeight: '600', fontSize: 14 }
})
